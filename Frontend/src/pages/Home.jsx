...
// 1. DATA LAYER - Moved outside the component to prevent re-renders
const CATEGORIES = [
  {
    id: 1,
    ...
    image: "/api/placeholder/400/320" // Placeholder for when you add real images
  },
  {
    id: 2,
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 font-sans text-slate-900">
      ...
      <main className="flex-grow">
        ...
        <section className="py-16 md:py-24 container mx-auto px-4 md:px-8" aria-labelledby="category-heading">
          <div className="text-center mb-16">
            <h2 id="category-heading" className="text-3xl md:text-4xl font-black mb-4 tracking-tight">
              Student Essentials
            </h2>
            <div className="w-20 h-1.5 bg-teal-500 mx-auto rounded-full"></div>
            <p className="mt-4 text-slate-600 max-w-md mx-auto">
              Everything you need for campus life, hand-picked for you.
            </p>
          </div>
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center">
        <h3 className="text-white text-2xl font-bold tracking-wide drop-shadow-md transition-transform duration-300 group-hover:scale-105 whitespace-pre-line">
          {category.name.replace(" And Instruments", " And\nInstruments").replace(" And Clothing", " And\nClothing")}
        </h3>
