...
import { RegisterUser, VerifyOtpThunk } from '../Authslice';
...
export default function Signup() {
  ...
  const [userEmail, setUserEmail] = useState('');  // email between steps
        ...
        {step === 1 ? (
            ...
            <div>
              <div className="grid grid-cols-2 gap-4 mb-5">
                <div className="relative group">
                  ...
                  <input
                    type="text"
                    id="firstname"
                    className={`w-full px-4 py-3 text-base text-slate-800 bg-white/90 border-2 rounded-xl outline-none transition-all duration-300 placeholder:text-slate-400 focus:ring-4 focus:bg-white ${errors.firstname ? 'border-red-500 focus:border-red-500 focus:ring-red-500/15' : 'border-slate-200 focus:border-brand-teal focus:ring-brand-teal/15'
                      }`}
                ...
                <div className="relative group">
                  ...
                  <input
                    type="text"
                    id="lastname"
                    className={`w-full px-4 py-3 text-base text-slate-800 bg-white/90 border-2 rounded-xl outline-none transition-all duration-300 placeholder:text-slate-400 focus:ring-4 focus:bg-white ${errors.lastname ? 'border-red-500 focus:border-red-500 focus:ring-red-500/15' : 'border-slate-200 focus:border-brand-teal focus:ring-brand-teal/15'
                      }`}
              ...
              <div className="mb-5 relative group">
                ...
                <input
                  type="email"
                  id="email"
                  className={`w-full px-4 py-3 text-base text-slate-800 bg-white/90 border-2 rounded-xl outline-none transition-all duration-300 placeholder:text-slate-400 focus:ring-4 focus:bg-white ${errors.email ? 'border-red-500 focus:border-red-500 focus:ring-red-500/15' : 'border-slate-200 focus:border-brand-teal focus:ring-brand-teal/15'
                    }`}
                  placeholder="college mail preferred"
                  {...register('email')}
                />
                {errors.email && (
              ...
              <div className="mb-5 relative group">
                <label htmlFor="contactNumber" className="block text-sm font-semibold text-slate-700 mb-1.5 transition-colors duration-300 group-focus-within:text-[#00B4DB]">Contact Number</label>
                <div className="relative flex">
                  <span className="inline-flex items-center px-4 py-3 text-base font-medium text-slate-500 bg-slate-100 border-2 border-r-0 border-slate-200 rounded-l-xl">
                    +91
                  </span>
                  <input
                    type="text"
                    id="contactNumber"
                    className={`w-full px-4 py-3 text-base text-slate-800 bg-white/90 border-2 rounded-r-xl outline-none transition-all duration-300 placeholder:text-slate-400 focus:ring-4 focus:bg-white ${errors.contactNumber ? 'border-red-500 focus:border-red-500 focus:ring-red-500/15' : 'border-slate-200 focus:border-brand-teal focus:ring-brand-teal/15'
                      }`}
                ...
                {errors.contactNumber && (
                  <p className="mt-1 text-xs text-red-500 font-medium">{errors.contactNumber.message}</p>
                )}
              </div>
              ...
              <div className="mb-5 relative group">
                ...
                <div className="relative">
                  ...
                  <select
                    id="college"
                    className={`w-full px-4 py-3 text-base text-slate-800 bg-white/90 border-2 rounded-xl outline-none transition-all duration-300 focus:ring-4 focus:bg-white appearance-none cursor-pointer ${errors.college ? 'border-red-500 focus:border-red-500 focus:ring-red-500/15' : 'border-slate-200 focus:border-brand-teal focus:ring-brand-teal/15'
                      }`}
                    {...register('college')}
                  >
              ...
              <div className="mb-5 relative group">
                ...
                <div className="relative">
                  <input
                    ...
                    id="password"
                    className={`w-full px-4 py-3 text-base text-slate-800 bg-white/90 border-2 rounded-xl outline-none transition-all duration-300 placeholder:text-slate-400 focus:ring-4 focus:bg-white pr-10 ${errors.password ? 'border-red-500 focus:border-red-500 focus:ring-red-500/15' : 'border-slate-200 focus:border-brand-teal focus:ring-brand-teal/15'
                      }`}
                    placeholder="••••••••"
                    {...register('password')}
                  />
              ...
              <div className="mb-8 relative group">
                ...
                <div className="relative">
                  <input
                    ...
                    id="confirmPassword"
                    className={`w-full px-4 py-3 text-base text-slate-800 bg-white/90 border-2 rounded-xl outline-none transition-all duration-300 placeholder:text-slate-400 focus:ring-4 focus:bg-white pr-10 ${errors.confirmPassword ? 'border-red-500 focus:border-red-500 focus:ring-red-500/15' : 'border-slate-200 focus:border-brand-teal focus:ring-brand-teal/15'
                      }`}
                    placeholder="••••••••"
          ...
          <div className="flex flex-col items-center gap-4 py-4">
            <p className="text-slate-600 text-sm text-center">
              We sent a 6-digit OTP to <b>{userEmail}</b>. Enter it below.
            </p>
            <input
              type="text"
              maxLength={6}
              ...
              className="w-full text-center text-2xl font-bold tracking-[0.5em] px-4 py-3 border-2 border-slate-200 rounded-xl outline-none focus:border-brand-teal focus:ring-4 focus:ring-brand-teal/15"
            />
            ...
            <button
              ...
              disabled={loading}
              className="w-full p-3.5 text-base font-bold text-white bg-gradient-to-br from-brand-red to-brand-orange rounded-xl cursor-pointer transition-all duration-300 hover:-translate-y-0.5 disabled:opacity-70 disabled:cursor-not-allowed flex justify-center items-center"
            >
